...
Your license key is delivered via email after purchase and is also available in your account dashboard at [scanpick.cc/account](https://scanpick.cc/account).
...
All purchases are processed via Stripe. We accept major credit cards. Prices are listed at [scanpick.cc/#pricing](https://scanpick.cc/#pricing).
...
2. The license key also appears in your account dashboard at [scanpick.cc/account](https://scanpick.cc/account)
3. Download links for the ScanPick binary are available in your account dashboard
4. The binary is also available via [GitHub Releases](https://github.com/timDeHof/scanpick/releases)

Installation instructions are at [docs.scanpick.cc](https://docs.scanpick.cc).
