...
This End User License Agreement ("EULA") is a legal agreement between you ("Licensee") and Timothy DeHof ("Licensor") for the use of ScanPick software.

**By purchasing, downloading, installing, or using ScanPick, you agree to be bound by this EULA.** If you do not agree, do not purchase, download, install, or use ScanPick.
...
Licensee is responsible for safeguarding their license key. Lost keys can be retrieved by logging into [scanpick.cc/account](https://scanpick.cc/account).
